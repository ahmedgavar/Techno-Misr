        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title" style="text-align: center"> الصلاحيات </h3><br><br>
                    <a href="/roles/create" class="btn btn-primary ">صلاحية جديدة</a>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" style="text-align: center">  كل الصلاحيات  </h4>
