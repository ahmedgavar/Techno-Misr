                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                                                ...
                                                                @foreach ($permissions as $perm)
                                                                    <div class="form-group col-sm-4">
                                                                        <label class="checkbox-inline">
                                                                            <input type="checkbox" class="chk-box" name="permissions[]" value="{{ $perm->name }}"{{ in_array($perm->name,  $role->permissions)? 'checked' : '' }}>    {{ $perm->name }}
                                                                        </label>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                            ...
                                            <div class="form-actions" style="margin-right: 350px">
